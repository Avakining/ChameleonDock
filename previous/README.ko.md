...
- 이 모드는 Minecraft 1.12.2 상위 클라이언트가 macOS에서 실행될 때, **독 아이콘을 로드하지 못하는 [문제](https://bugs.mojang.com/browse/MC-248936)** 를
  해결합니다.
- 또한, Apple Silicon 기기에서 Minecraft 1.18 미만 클라이언트를 실행했을 때 발생하는
  `GLFW error 65548: Cocoa: Regular windows do not have icons on macOS` 오류를 해결합니다.
