...
- This mod fixes the [issue](https://bugs.mojang.com/browse/MC-248936) that Minecraft icon does not appear while running
  in macOS Dock on Minecraft 1.13 client or above.
- Also, this mod fixes the `GLFW error 65548: Cocoa: Regular windows do not have icons on macOS` error when you run
  Minecraft 1.17.1 client or lower on Apple Silicon devices.
...
- You can change Dock icon using client command `/changeicon <icon name>` or add icon using **Custom Resource Pack**, if
  you want.
